...
void crearArchivos(int cantidad) {
    ...
    for(i=0; i<cantidad; i++){
        ofstream file;
        file.open("C:/Users/PC/Documents/progra/" + nombreArchivo + to_string(i) +".txt");
        file << "primera línea\n";
        file << "segunda línea\n";
        file << "tercera línea\n";
        file.close();
...
void listarArchivosDeDirectorio(){
    ...
    HANDLE          hFind;
    hFind = FindFirstFile("C:/Users/PC/Documents/progra/*", &findFileData);
...
void mostrarDetalles(){
    std::filesystem::directory_iterator directoryIterator("C:/Users/PC/Documents/progra");
